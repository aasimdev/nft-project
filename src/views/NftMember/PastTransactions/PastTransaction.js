...
import { seriestype, recentTransactions } from '../../../data/data';
import SealAttributes from '../components/SealAttributes';

import noRecentTransaction from '../../../assets/img/norecenttransaction.png'
        ...
        <Container>
            <div className='nftsub'>
                ...
                {recentTransactions.length > 0 ?
                    ...
                    : <NoTicketHolder icon={noRecentTransaction} text="No recent transactions" />}
            </div>
